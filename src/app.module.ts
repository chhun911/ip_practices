...
@Module({
  imports: [
    ...
    // ============================================
    // Practice 12 - GraphQL Module Configuration
    // ============================================
    GraphQLModule.forRoot<ApolloDriverConfig>({
      driver: ApolloDriver,

      // ✅ Schema-First Approach (Part A)
      // Uses .graphql schema files to define types
      typePaths: [join(process.cwd(), 'src/graphql/schema/*.graphql')],

      // ✅ Code-First Approach (Part B) - Uncomment to use
      // Auto-generates schema from TypeScript decorators
      // autoSchemaFile: join(process.cwd(), 'src/graphql/schema.gql'),

      // Enable GraphQL Playground at /graphql
      playground: true,
    }),
